...
def get_detail_info_from(url):
    ...
    try:
        ...
        prices = soup.select("#wrapper > div.content.clearfix > div.leftBox > div > div > ul > li > i.f22.fc-orange.f-type")
        price = prices[0].text if prices else None
        locations = soup.select('#wrapper > div.content.clearfix > div.leftBox > div:nth-of-type(3) > div > ul > li:nth-of-type(3)')[0].find_all("a")
